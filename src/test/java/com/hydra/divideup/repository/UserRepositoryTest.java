...
class UserRepositoryTest {
  ...
  @Test
  void whenFindByEmailOrPhone_thenUserCanBeRetrieved() {
    User user1 = new User();
    user1.setName("test1");
    ...
    List<User> found = userRepository.findByEmailOrPhone("test@gmail.com", "0987654321");
    assertThat(found).isNotNull().hasSize(2).extracting(User::getName).contains("test1", "test2");
    List<User> found1 = userRepository.findByEmailOrPhone(null, null);
    assertThat(found1).isNotNull().isEmpty();
    List<User> found2 = userRepository.findByEmailOrPhone("test3@gmail.com", "0987654321");
    assertThat(found2).isNotNull().hasSize(1).extracting(User::getName).contains("test2");
    List<User> found3 = userRepository.findByEmailOrPhone("test3@gmail.com", "5784675678");

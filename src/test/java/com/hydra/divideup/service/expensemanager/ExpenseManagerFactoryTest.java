...
public class ExpenseManagerFactoryTest {
  ...
  @Mock private EqualExpenseManager equalExpenseManager;

  @Mock private UnEqualExpenseManager unEqualExpenseManager;

  @Mock private PercentageExpenseManager percentageExpenseManager;

  @Mock private ShareExpenseManager shareExpenseManager;

  @InjectMocks private ExpenseManagerFactory expenseManagerFactory;
  ...
  void setup() {
    ...
    when(applicationContext.getBean("percentageExpenseManager"))
        .thenReturn(percentageExpenseManager);
  ...
  void testGetExpenseManagerEqual() {
    ...
    assertInstanceOf(
        EqualExpenseManager.class, manager, "Expected manager to be of type equalExpenseManager");
  ...
  void testGetExpenseManagerUnequal() {
    ...
    assertInstanceOf(
        UnEqualExpenseManager.class,
        manager,
        "Expected manager to be of type UnequalExpenseManager");
  ...
  void testGetExpenseManagerPercentage() {
    ...
    assertInstanceOf(
        PercentageExpenseManager.class,
        manager,
        "Expected manager to be of type percentageExpenseManager");
  ...
  void testGetExpenseManagerShare() {
    ...
    assertInstanceOf(
        ShareExpenseManager.class, manager, "Expected manager to be of type shareExpenseManager");

...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleDivideUpException(
      DivideUpException divideUpException) {
  ...
  private ResponseEntity<ErrorResponse> buildErrorResponse(DivideUpError divideUpError) {
    return ResponseEntity.internalServerError()
        .body(
            new ErrorResponse(
                divideUpError.getCode(), divideUpError.getMessage(), divideUpError.getTimestamp()));
  }
